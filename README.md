...
[![CI](https://github.com/PlatformStackPulse/tf-atom-cloudwatch-log-subscription-filter-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-cloudwatch-log-subscription-filter-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS CloudWatch Log Subscription Filter - streams logs to a destination.
...
|------|-------------|------|---------|:--------:|
| <a name="input_destination_arn"></a> [destination\_arn](#input\_destination\_arn) | ARN of the destination (Lambda, Kinesis, Firehose) | `string` | n/a | yes |
| <a name="input_log_group_name"></a> [log\_group\_name](#input\_log\_group\_name) | Name of the log group to subscribe to | `string` | n/a | yes |
...
| <a name="input_filter_pattern"></a> [filter\_pattern](#input\_filter\_pattern) | Filter pattern for log events (empty string for all) | `string` | `""` | no |
...
| <a name="input_role_arn"></a> [role\_arn](#input\_role\_arn) | IAM role ARN for the subscription (required for Kinesis) | `string` | `null` | no |
