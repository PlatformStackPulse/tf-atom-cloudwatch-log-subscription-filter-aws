...
|------|-------------|------|---------|:--------:|
| <a name="input_destination_arn"></a> [destination\_arn](#input\_destination\_arn) | ARN of the destination to deliver matching log events to (Lambda, Kinesis, or Firehose). | `string` | n/a | yes |
| <a name="input_log_group_name"></a> [log\_group\_name](#input\_log\_group\_name) | Name of the CloudWatch log group to associate the subscription filter with. | `string` | n/a | yes |
...
| <a name="input_distribution"></a> [distribution](#input\_distribution) | Method used to distribute log data to the destination: Random or ByLogStream. | `string` | `null` | no |
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Set to false to prevent the module from creating any resources. | `bool` | `null` | no |
| <a name="input_environment"></a> [environment](#input\_environment) | ID element. Usually used for region e.g. 'uw2', 'us-west-2', OR role 'prod', 'staging', 'dev', 'UAT'. | `string` | `null` | no |
| <a name="input_filter_name"></a> [filter\_name](#input\_filter\_name) | Name of the subscription filter. Defaults to the tf-label id (module.this.id) when null. | `string` | `null` | no |
| <a name="input_filter_pattern"></a> [filter\_pattern](#input\_filter\_pattern) | Filter pattern for subscribing to a filtered stream of log events. Use "" to match all events. | `string` | `""` | no |
...
| <a name="input_role_arn"></a> [role\_arn](#input\_role\_arn) | ARN of an IAM role that grants CloudWatch Logs permission to deliver events to the destination. Required for Kinesis/Firehose. | `string` | `null` | no |
...
| <a name="output_id"></a> [id](#output\_id) | The id (name) of the CloudWatch log subscription filter. |
<!-- END_TF_DOCS -->
